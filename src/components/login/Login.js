...
const Login = () => {
    ...
    return (
        <Container className="text-center text-white" id="bg-img"> 
            <div className="mx-auto p-3" id="login">
                <Form onSubmit={subForm}>
                    ...
                    <button className="btn-warning btn-lg" type="submit">{newUser ? 'Sign Up' : 'Login'}</button>

                    {
                        !newUser && <span onClick={forgotPass} className="btn text-light">Forgot Password</span>
                    }
